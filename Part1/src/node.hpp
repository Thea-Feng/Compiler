...
struct Node {
    ...
    void append_child(Node* child) {
        ...
        // std::cout<<" appended a child "<<child->lexeme<<std::endl;
    }
    void append_child_first(Node *child) {
...
/*
getLabel(SymbolClass::PROGRAM)
getLabel(SymbolClass::START)
getLabel(SymbolClass::STATEMENT_LIST)
getLabel(SymbolClass::STATEMENT)
getLabel(SymbolClass::STATEMENT)
getLabel(SymbolClass::ID_LIST)
getLabel(SymbolClass::EXPRESSION_LIST)
getLabel(SymbolClass::EXPRESSION)
getLabel(SymbolClass::PRIMARY)
getLabel(SymbolClass::MINUSOP)
getLabel(SymbolClass::PLUSOP)
*/
